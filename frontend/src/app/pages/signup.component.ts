...
@Component({
  ...
  template: `
    ...
    <p class="muted">Create an account to access the dashboard.</p>
    ...
    <form [formGroup]="form" (ngSubmit)="submit()">
      ...
      <button type="submit" [disabled]="form.invalid || loading()">Send signup OTP</button>
    </form>
...
export class SignupComponent {
  ...
  submit() {
    ...
    this.auth.signup({ email, password }).subscribe({
      next: (text) => {
        this.message.set(text || 'OTP sent to your email. Verify to finish signup.');
